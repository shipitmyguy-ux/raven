...
assert.doesNotMatch(llmRouter,/openrouter\.ai|RAVEN_OPENROUTER_API_KEY/,"OpenRouter is not part of Raven routing.");
assert.doesNotMatch(writer,/api\.openai\.com|generativelanguage\.googleapis\.com/,"Grounded writer must remain provider neutral.");
