window.RAVEN_CONFIG = {
  searchApiUrl: "https://umvmilulnqnmeqvfoxxc.supabase.co/functions/v1/raven-backend-v3",
  ...
  controlApiUrl: "https://umvmilulnqnmeqvfoxxc.supabase.co/functions/v1/raven-control-v1",
