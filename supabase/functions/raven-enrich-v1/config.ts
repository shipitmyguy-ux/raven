...
export const TRACKS: Record<Track,{terms:string[];include:string[];exclude:string[];localOnly?:boolean}> = {
  Professional: {
  ...
  Labor: {
    terms:["Maintenance Technician","Facilities Technician","Grounds Maintenance","Parks Maintenance","Trail Maintenance","Painter","Pressure Washing","Warehouse","Production Technician","Field Service Technician","Repair Technician","Assembly Technician"],
    include:["maintenance","facilities","grounds","parks","trail","painter","pressure washing","warehouse","production technician","field service","repair technician","assembly"],
